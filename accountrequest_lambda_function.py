...
def lambda_handler(event, context):
    ...
    account_info = event['body']['event']
    AccountEmail = account_info.get('AccountEmail')
    AccountName  = account_info.get('AccountName')
    ManagedOrganizationalUnit = account_info.get('ManagedOrganizationalUnit')
    SSOUserEmail     = account_info.get('SSOUserEmail')
    SSOUserFirstName = account_info.get('SSOUserFirstName')
    SSOUserLastName  = account_info.get('SSOUserLastName')
    ProjectId = account_info.get('ProjectId')
